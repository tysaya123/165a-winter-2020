...
# NOTE: Must be a multiple of 5
DISTINCT_RECORDS = 1000

# Generate random records
for i in range(0, DISTINCT_RECORDS):
    key = 92106429 + i
    keys.append(key)
...
for i in range(NUM_TRANSACTIONS):
    k = randint(0, (DISTINCT_RECORDS // 5)- 1)
...
num_aborts = NUM_TRANSACTIONS - num_committed_transactions
print('Num aborts:', num_aborts)
